...
- [ ] assaultvest - Assault Vest (Gen 6) - 2 callbacks: onModifySpD, onDisableMove
...
- [ ] charcoal - Charcoal (Gen 2) - 1 callback: onBasePower
...
- [ ] chilldrive - Chill Drive (Gen 5) - 1 callback: onTakeItem
- [ ] chimechite - Chimechite (Gen 9) - 1 callback: onTakeItem
- [ ] choiceband - Choice Band (Gen 3) - 3 callbacks: onStart, onModifyMove, onModifyAtk
- [ ] choicescarf - Choice Scarf (Gen 4) - 3 callbacks: onStart, onModifyMove, onModifySpe
- [ ] choicespecs - Choice Specs (Gen 4) - 3 callbacks: onStart, onModifyMove, onModifySpA
...
- [ ] cornerstonemask - Cornerstone Mask (Gen 9) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] deepseatooth - Deep Sea Tooth (Gen 3) - 1 callback: onModifySpA
- [ ] delphoxite - Delphoxite (Gen 9) - 1 callback: onTakeItem
- [ ] destinyknot - Destiny Knot (Gen 4) - 1 callback: onAttract
- [ ] diancite - Diancite (Gen 6) - 1 callback: onTakeItem
- [ ] dousedrive - Douse Drive (Gen 5) - 1 callback: onTakeItem
...
- [ ] dreadplate - Dread Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
- [ ] earthplate - Earth Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] eviolite - Eviolite (Gen 5) - 2 callbacks: onModifyDef, onModifySpD
...
- [ ] hardstone - Hard Stone (Gen 2) - 1 callback: onBasePower
- [ ] hawluchanite - Hawluchanite (Gen 9) - 1 callback: onTakeItem
- [ ] hearthflamemask - Hearthflame Mask (Gen 9) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] ironplate - Iron Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] magnet - Magnet (Gen 2) - 1 callback: onBasePower
...
- [ ] mindplate - Mind Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] seaincense - Sea Incense (Gen 3) - 1 callback: onBasePower
- [ ] sharpbeak - Sharp Beak (Gen 2) - 1 callback: onBasePower
- [ ] sharpedonite - Sharpedonite (Gen 6) - 1 callback: onTakeItem
- [ ] shedshell - Shed Shell (Gen 4) - 2 callbacks: onTrapPokemon, onMaybeTrapPokemon
- [ ] shellbell - Shell Bell (Gen 3) - 1 callback: onAfterMoveSecondarySelf
- [ ] shockdrive - Shock Drive (Gen 5) - 1 callback: onTakeItem
- [ ] shucaberry - Shuca Berry (Gen 4) - 2 callbacks: onSourceModifyDamage, onEat
- [ ] silkscarf - Silk Scarf (Gen 3) - 1 callback: onBasePower
- [ ] silverpowder - Silver Powder (Gen 2) - 1 callback: onBasePower
- [ ] sitrusberry - Sitrus Berry (Gen 3) - 3 callbacks: onUpdate, onTryEatItem, onEat
- [ ] skarmorite - Skarmorite (Gen 9) - 1 callback: onTakeItem
- [ ] skyplate - Sky Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
- [ ] slowbronite - Slowbronite (Gen 6) - 1 callback: onTakeItem
- [ ] snowball - Snowball (Gen 6) - 1 callback: onDamagingHit
- [ ] softsand - Soft Sand (Gen 2) - 1 callback: onBasePower
- [ ] souldew - Soul Dew (Gen 3) - 1 callback: onBasePower
- [ ] spelltag - Spell Tag (Gen 2) - 1 callback: onBasePower
- [ ] splashplate - Splash Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
- [ ] spookyplate - Spooky Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] stoneplate - Stone Plate (Gen 4) - 2 callbacks: onBasePower, onTakeItem
...
- [ ] wellspringmask - Wellspring Mask (Gen 9) - 2 callbacks: onBasePower, onTakeItem
- [ ] whiteherb - White Herb (Gen 3) - 6 callbacks: onStart, onAnySwitchIn, onAnyAfterMega, onAnyAfterMove, onResidual, onUse
- [ ] widelens - Wide Lens (Gen 4) - 1 callback: onSourceModifyAccuracy
- [ ] wikiberry - Wiki Berry (Gen 3) - 3 callbacks: onUpdate, onTryEatItem, onEat
- [ ] wiseglasses - Wise Glasses (Gen 4) - 1 callback: onBasePower
