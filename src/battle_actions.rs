...
/// JavaScript uses HitEffect as a parameter to moveHit, which can be either
/// an ActiveMove or a SecondaryEffect
/// JavaScript equivalent: Dex.HitEffect (moveData parameter in moveHit)
#[derive(Debug, Clone)]
...
impl<'a> HitEffect<'a> {
    ...
    pub fn as_move(&self) -> Option<&ActiveMove> {
        match self {
