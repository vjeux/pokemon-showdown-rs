...
mod is_critical_hit;
mod run_mega_evo_check;
mod terastallize_check;
mod get_damage;
mod try_spread_move_hit_check;
mod move_hit_result;
...
mod try_spread_move_hit_stub;
mod hit_step_move_hit_loop_stub;
mod spread_move_hit_stub;
mod move_hit_stub;
mod get_spread_damage_stub;
mod force_switch_stub;
mod run_z_power;
mod run_mega_evo_stub;
mod terastallize_stub;
mod try_move_hit_stub;
mod secondaries_stub;
mod switch_in_stub;
mod drag_in_stub;
mod run_switch_stub;
