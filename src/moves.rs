...
pub static MOVES: Lazy<HashMap<ID, MoveDef>> = Lazy::new(|| {
    ...
    // === A moves ===
    map.insert(ID::new("10000000voltthunderbolt"), MoveDef {
        id: ID::new("10000000voltthunderbolt"),
        name: "10,000,000 Volt Thunderbolt".to_string(),
        base_power: 195,
        accuracy: 0, // always hits
        pp: 1,
        category: MoveCategory::Special,
    ...
    map.insert(ID::new("babydolleyes"), MoveDef {
        ...
        move_type: "Fairy".to_string(),
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, ..Default::default() },
        self_boosts: Some(vec![("atk".to_string(), -1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("banefulbunker"), MoveDef {
        ...
        move_type: "Poison".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("banefulbunker".to_string()),
        is_protect: true,
        ..Default::default()
    });
    ...
    map.insert(ID::new("batonpass"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        target: MoveTargetType::Self_,
        self_switch: Some("copyvolatile".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("bide"), MoveDef {
        ...
        volatile_status: Some("bide".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("bodypress"), MoveDef {
        ...
        move_type: "Fighting".to_string(),
        flags: MoveFlags { contact: true, protect: true, mirror: true, ..Default::default() },
        override_offensive_stat: Some("def".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("bounce"), MoveDef {
        ...
        move_type: "Flying".to_string(),
        target: MoveTargetType::Any,
        flags: MoveFlags { contact: true, charge: true, protect: true, mirror: true, gravity: true, ..Default::default() },
        is_two_turn: true,
        secondaries: vec![SecondaryEffect {
            chance: 30,
            status: Some("par".to_string()),
    ...
    map.insert(ID::new("burningbulwark"), MoveDef {
        ...
        move_type: "Fire".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("burningbulwark".to_string()),
        is_protect: true,
        ..Default::default()
    });
    ...
    map.insert(ID::new("captivate"), MoveDef {
        ...
        target: MoveTargetType::AllAdjacentFoes,
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, ..Default::default() },
        target_boosts: Some(vec![("spa".to_string(), -2)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("charge"), MoveDef {
        ...
        move_type: "Electric".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("charge".to_string()),
    ...
    map.insert(ID::new("charm"), MoveDef {
        ...
        move_type: "Fairy".to_string(),
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, ..Default::default() },
        target_boosts: Some(vec![("atk".to_string(), -2)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("chillyreception"), MoveDef {
        ...
        self_switch: Some("normal".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("clangoroussoul"), MoveDef {
        ...
        move_type: "Dragon".to_string(),
        target: MoveTargetType::Self_,
        flags: MoveFlags { sound: true, ..Default::default() },
        self_boosts: Some(vec![
            ("atk".to_string(), 1), ("def".to_string(), 1), ("spa".to_string(), 1),
            ("spd".to_string(), 1), ("spe".to_string(), 1)
        ]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("coaching"), MoveDef {
        ...
        category: MoveCategory::Status,
        move_type: "Fighting".to_string(),
        target: MoveTargetType::AdjacentAlly,
        target_boosts: Some(vec![("atk".to_string(), 1), ("def".to_string(), 1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("coil"), MoveDef {
        ...
        move_type: "Poison".to_string(),
        target: MoveTargetType::Self_,
        self_boosts: Some(vec![("atk".to_string(), 1), ("def".to_string(), 1), ("accuracy".to_string(), 1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("comeuppance"), MoveDef {
        ...
        category: MoveCategory::Physical,
        move_type: "Dark".to_string(),
        target: MoveTargetType::Scripted,
        flags: MoveFlags { contact: true, protect: true, mirror: true, ..Default::default() },
        ..Default::default()
    });
    ...
    map.insert(ID::new("confide"), MoveDef {
        ...
        target_boosts: Some(vec![("spa".to_string(), -1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("cottonspore"), MoveDef {
        ...
        target: MoveTargetType::AllAdjacentFoes,
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, powder: true, ..Default::default() },
        target_boosts: Some(vec![("spe".to_string(), -2)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("curse"), MoveDef {
        ...
        category: MoveCategory::Status,
        move_type: "Ghost".to_string(),
        volatile_status: Some("curse".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("decorate"), MoveDef {
        ...
        category: MoveCategory::Status,
        move_type: "Fairy".to_string(),
        target_boosts: Some(vec![("atk".to_string(), 2), ("spa".to_string(), 2)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("defensecurl"), MoveDef {
        ...
        target: MoveTargetType::Self_,
        self_boosts: Some(vec![("def".to_string(), 1)]),
        volatile_status: Some("defensecurl".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("destinybond"), MoveDef {
        ...
        move_type: "Ghost".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("destinybond".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("doodle"), MoveDef {
        ...
        category: MoveCategory::Status,
        move_type: "Normal".to_string(),
        target: MoveTargetType::AdjacentFoe,
        ..Default::default()
    });
    ...
    map.insert(ID::new("doubleteam"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        target: MoveTargetType::Self_,
        self_boosts: Some(vec![("evasion".to_string(), 1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("endure"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("endure".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("extremeevoboost"), MoveDef {
        ...
        is_z: true,
        self_boosts: Some(vec![
            ("atk".to_string(), 2), ("def".to_string(), 2), ("spa".to_string(), 2),
            ("spd".to_string(), 2), ("spe".to_string(), 2)
        ]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("faketears"), MoveDef {
        ...
        move_type: "Dark".to_string(),
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, ..Default::default() },
        target_boosts: Some(vec![("spd".to_string(), -2)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("flash"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        flags: MoveFlags { protect: true, reflectable: true, mirror: true, ..Default::default() },
        target_boosts: Some(vec![("accuracy".to_string(), -1)]),
        ..Default::default()
    });
    ...
    map.insert(ID::new("focusenergy"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("focusenergy".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("followme"), MoveDef {
        ...
        move_type: "Normal".to_string(),
        target: MoveTargetType::Self_,
        volatile_status: Some("followme".to_string()),
        ..Default::default()
    });
    ...
    map.insert(ID::new("foulplay"), MoveDef {
        ...
        move_type: "Dark".to_string(),
        flags: MoveFlags { contact: true, protect: true, mirror: true, ..Default::default() },
        override_offensive_pokemon: Some("target".to_string()),
        ..Default::default()
    });
