...
pub fn dispatch_condition_on_start(
    ...
    match condition_id {
        ...
        "counter" => counter::condition::on_start(battle, None, Some(pokemon_pos), effect),
        ...
        "dragoncheer" => dragoncheer::condition::on_start(battle, None, Some(pokemon_pos), effect),
        ...
        "focusenergy" => focusenergy::condition::on_start(battle, None, Some(pokemon_pos), effect),
        "focuspunch" => focuspunch::condition::on_start(battle, pokemon_pos),
        "followme" => followme::condition::on_start(battle, None, Some(pokemon_pos), effect),
        ...
        "gmaxchistrike" => gmaxchistrike::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        ...
        "helpinghand" => helpinghand::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        ...
        "magiccoat" => magiccoat::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        ...
        "mirrorcoat" => {
            mirrorcoat::condition::on_start(battle, Some(pokemon_pos), source_pos, effect)
        }
        ...
        "roost" => roost::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        ...
        "substitute" => substitute::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        ...
        "yawn" => yawn::condition::on_start(battle, Some(pokemon_pos), source_pos, effect),
        _ => EventResult::Continue,
    }
}
