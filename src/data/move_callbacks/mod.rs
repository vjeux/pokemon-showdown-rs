...
pub fn dispatch_on_base_power(
    ...
    match move_id {
        ...
        "fusionflare" => fusionflare::on_base_power(battle, base_power, pokemon_pos, target_pos),
        ...
        "solarblade" => solarblade::on_base_power(battle, base_power, pokemon_pos, target_pos),
        "venoshock" => venoshock::on_base_power(battle, base_power, pokemon_pos, target_pos),
        _ => EventResult::Continue,
    }
}
...
pub fn dispatch_on_hit(
    ...
    match move_id {
        ...
        "banefulbunker" => banefulbunker::on_hit(battle, pokemon_pos, target_pos),
        "batonpass" => batonpass::on_hit(battle, pokemon_pos, target_pos),
        "bellydrum" => bellydrum::on_hit(battle, pokemon_pos, target_pos),
        "bestow" => bestow::on_hit(battle, pokemon_pos, target_pos),
        ...
        "conversion" => conversion::on_hit(battle, pokemon_pos, target_pos),
        "conversion2" => conversion2::on_hit(battle, pokemon_pos, target_pos),
        "copycat" => copycat::on_hit(battle, pokemon_pos, target_pos),
        "coreenforcer" => coreenforcer::on_hit(battle, pokemon_pos, target_pos),
        "corrosivegas" => corrosivegas::on_hit(battle, pokemon_pos, target_pos),
        ...
        "flameburst" => flameburst::on_hit(battle, pokemon_pos, target_pos),
        ...
        "gmaxmalodor" => gmaxmalodor::on_hit(battle, pokemon_pos, target_pos),
        "gmaxmeltdown" => gmaxmeltdown::on_hit(battle, pokemon_pos, target_pos),
        "gmaxreplenish" => gmaxreplenish::on_hit(battle, pokemon_pos, target_pos),
        ...
        "healpulse" => healpulse::on_hit(battle, pokemon_pos, target_pos),
        "heartswap" => heartswap::on_hit(battle, pokemon_pos, target_pos),
        "incinerate" => incinerate::on_hit(battle, pokemon_pos, target_pos),
        "instruct" => instruct::on_hit(battle, pokemon_pos, target_pos),
        "jawlock" => jawlock::on_hit(battle, pokemon_pos, target_pos),
        "junglehealing" => junglehealing::on_hit(battle, pokemon_pos, target_pos),
        "kingsshield" => kingsshield::on_hit(battle, pokemon_pos, target_pos),
        "lockon" => lockon::on_hit(battle, pokemon_pos, target_pos),
        ...
        "maxphantasm" => maxphantasm::on_hit(battle, pokemon_pos, target_pos),
        ...
        "mindreader" => mindreader::on_hit(battle, pokemon_pos, target_pos),
        "moonlight" => moonlight::on_hit(battle, pokemon_pos, target_pos),
        "morningsun" => morningsun::on_hit(battle, pokemon_pos, target_pos),
        "obstruct" => obstruct::on_hit(battle, pokemon_pos, target_pos),
        "painsplit" => painsplit::on_hit(battle, pokemon_pos, target_pos),
        "partingshot" => partingshot::on_hit(battle, pokemon_pos, target_pos),
        "pluck" => pluck::on_hit(battle, pokemon_pos, target_pos),
        "polarflare" => polarflare::on_hit(battle, pokemon_pos, target_pos),
        "pollenpuff" => pollenpuff::on_hit(battle, pokemon_pos, target_pos),
        "powersplit" => powersplit::on_hit(battle, pokemon_pos, target_pos),
        "powerswap" => powerswap::on_hit(battle, pokemon_pos, target_pos),
        "protect" => protect::on_hit(battle, pokemon_pos, target_pos),
        "psychup" => psychup::on_hit(battle, pokemon_pos, target_pos),
        "purify" => purify::on_hit(battle, pokemon_pos, target_pos),
        "quash" => quash::on_hit(battle, pokemon_pos, target_pos),
        "recycle" => recycle::on_hit(battle, pokemon_pos, target_pos),
        "reflecttype" => reflecttype::on_hit(battle, pokemon_pos, target_pos),
        "refresh" => refresh::on_hit(battle, pokemon_pos, target_pos),
        "relicsong" => relicsong::on_hit(battle, pokemon_pos, target_pos),
        "rest" => rest::on_hit(battle, pokemon_pos, target_pos),
        "roleplay" => roleplay::on_hit(battle, pokemon_pos, target_pos),
        "sappyseed" => sappyseed::on_hit(battle, pokemon_pos, target_pos),
        "shedtail" => shedtail::on_hit(battle, pokemon_pos, target_pos),
        "shellsidearm" => shellsidearm::on_hit(battle, pokemon_pos, target_pos),
        "shoreup" => shoreup::on_hit(battle, pokemon_pos, target_pos),
        "silktrap" => silktrap::on_hit(battle, pokemon_pos, target_pos),
        "simplebeam" => simplebeam::on_hit(battle, pokemon_pos, target_pos),
        "sketch" => sketch::on_hit(battle, pokemon_pos, target_pos),
        "skillswap" => skillswap::on_hit(battle, pokemon_pos, target_pos),
        "skydrop" => skydrop::on_hit(battle, pokemon_pos, target_pos),
        "sleeptalk" => sleeptalk::on_hit(battle, pokemon_pos, target_pos),
        ...
        "splinteredstormshards" => splinteredstormshards::on_hit(battle, pokemon_pos, target_pos),
        "steelroller" => steelroller::on_hit(battle, pokemon_pos, target_pos),
        "strengthsap" => strengthsap::on_hit(battle, pokemon_pos, target_pos),
        "stuffcheeks" => stuffcheeks::on_hit(battle, pokemon_pos, target_pos),
        "substitute" => substitute::on_hit(battle, pokemon_pos, target_pos),
        "swallow" => swallow::on_hit(battle, pokemon_pos, target_pos),
        "switcheroo" => switcheroo::on_hit(battle, pokemon_pos, target_pos),
        "synthesis" => synthesis::on_hit(battle, pokemon_pos, target_pos),
        "takeheart" => takeheart::on_hit(battle, pokemon_pos, target_pos),
        "thousandwaves" => thousandwaves::on_hit(battle, pokemon_pos, target_pos),
        "tidyup" => tidyup::on_hit(battle, pokemon_pos, target_pos),
        "topsyturvy" => topsyturvy::on_hit(battle, pokemon_pos, target_pos),
        "transform" => transform::on_hit(battle, pokemon_pos, target_pos),
        "trick" => trick::on_hit(battle, pokemon_pos, target_pos),
        "trickortreat" => trickortreat::on_hit(battle, pokemon_pos, target_pos),
        "venomdrench" => venomdrench::on_hit(battle, pokemon_pos, target_pos),
        "wakeupslap" => wakeupslap::on_hit(battle, pokemon_pos, target_pos),
        "worryseed" => worryseed::on_hit(battle, pokemon_pos, target_pos),
        _ => EventResult::Continue,
    }
}
...
pub fn dispatch_on_try_hit(
    ...
    match move_id {
        "autotomize" => autotomize::on_try_hit(battle, source_pos, target_pos),
        "brickbreak" => brickbreak::on_try_hit(battle, source_pos, target_pos),
        "celebrate" => celebrate::on_try_hit(battle, source_pos, target_pos),
        "clangoroussoul" => clangoroussoul::on_try_hit(battle, source_pos, target_pos),
        "curse" => curse::on_try_hit(battle, source_pos, target_pos),
        "disable" => disable::on_try_hit(battle, source_pos, target_pos),
        "electrify" => electrify::on_try_hit(battle, source_pos, target_pos),
        "entrainment" => entrainment::on_try_hit(battle, source_pos, target_pos),
        "filletaway" => filletaway::on_try_hit(battle, source_pos, target_pos),
        "foresight" => foresight::on_try_hit(battle, source_pos, target_pos),
        "gastroacid" => gastroacid::on_try_hit(battle, source_pos, target_pos),
        "grassknot" => grassknot::on_try_hit(battle, source_pos, target_pos),
        "happyhour" => happyhour::on_try_hit(battle, source_pos, target_pos),
        "healingwish" => healingwish::on_try_hit(battle, source_pos, target_pos),
        "heatcrash" => heatcrash::on_try_hit(battle, source_pos, target_pos),
        "heavyslam" => heavyslam::on_try_hit(battle, source_pos, target_pos),
        "helpinghand" => helpinghand::on_try_hit(battle, source_pos, target_pos),
        "lockon" => lockon::on_try_hit(battle, source_pos, target_pos),
        "lowkick" => lowkick::on_try_hit(battle, source_pos, target_pos),
        "lunardance" => lunardance::on_try_hit(battle, source_pos, target_pos),
        "mefirst" => mefirst::on_try_hit(battle, source_pos, target_pos),
        "mindreader" => mindreader::on_try_hit(battle, source_pos, target_pos),
        "miracleeye" => miracleeye::on_try_hit(battle, source_pos, target_pos),
        "mirrormove" => mirrormove::on_try_hit(battle, source_pos, target_pos),
        "naturepower" => naturepower::on_try_hit(battle, source_pos, target_pos),
        "odorsleuth" => odorsleuth::on_try_hit(battle, source_pos, target_pos),
        "pollenpuff" => pollenpuff::on_try_hit(battle, source_pos, target_pos),
        "poltergeist" => poltergeist::on_try_hit(battle, source_pos, target_pos),
        "psychicfangs" => psychicfangs::on_try_hit(battle, source_pos, target_pos),
        "psychoshift" => psychoshift::on_try_hit(battle, source_pos, target_pos),
        "pursuit" => pursuit::on_try_hit(battle, source_pos, target_pos),
        "ragingbull" => ragingbull::on_try_hit(battle, source_pos, target_pos),
        "revivalblessing" => revivalblessing::on_try_hit(battle, source_pos, target_pos),
        "roleplay" => roleplay::on_try_hit(battle, source_pos, target_pos),
        "shedtail" => shedtail::on_try_hit(battle, source_pos, target_pos),
        "simplebeam" => simplebeam::on_try_hit(battle, source_pos, target_pos),
        "skillswap" => skillswap::on_try_hit(battle, source_pos, target_pos),
        "skydrop" => skydrop::on_try_hit(battle, source_pos, target_pos),
        "splash" => splash::on_try_hit(battle, source_pos, target_pos),
        "spotlight" => spotlight::on_try_hit(battle, source_pos, target_pos),
        "substitute" => substitute::on_try_hit(battle, source_pos, target_pos),
        "uproar" => uproar::on_try_hit(battle, source_pos, target_pos),
        "worryseed" => worryseed::on_try_hit(battle, source_pos, target_pos),
        "yawn" => yawn::on_try_hit(battle, source_pos, target_pos),
        _ => EventResult::Continue,
    }
}
