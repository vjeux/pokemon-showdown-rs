...
use crate::battle_actions::{DamageResult, HitEffect, ActiveMove};
...
pub fn move_hit<'a>(
    ...
    let (damages, _targets) = spread_move_hit(battle, &spread_targets, pokemon_pos, active_move, hit_effect, is_secondary, is_self);
