...
Total abilities: 314
Fully implemented (working code): ~208
Documented stubs (with detailed TODOs): ~106
...
6. **baddreams** - Damages sleeping foes by 1/8 max HP at end of turn

Progress: 203 → 208 abilities implemented (66.2%)
