/// Compare battle with seed 72 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed72-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 72])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 72]");
