/// Compare battle with seed 38 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed38-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 38])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 38]");
