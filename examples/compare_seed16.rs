/// Compare battle with seed 16 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed16-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 16])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 16]");
