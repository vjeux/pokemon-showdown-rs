/// Compare battle with seed 56 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed56-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 56])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 56]");
