/// Compare battle with seed 6 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed6-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 6])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 6]");
