/// Compare battle with seed 31 - Rust version
...
fn main() {
    let teams_json = fs::read_to_string("teams-seed31-rust.json").unwrap();
    ...
    let mut battle = Battle::new(BattleOptions {
        ...
        seed: Some(PRNGSeed::Gen5([0, 0, 0, 31])),
    ...
    eprintln!("RUST: Running battle with seed [0, 0, 0, 31]");
